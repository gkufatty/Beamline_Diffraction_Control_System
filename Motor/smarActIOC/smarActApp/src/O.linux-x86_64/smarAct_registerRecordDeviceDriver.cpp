...
static const char * const recordTypeNames[] = {
    ...
    "mbbiDirect", "mbbo", "mbboDirect", "motor", "permissive", "printf",
...
static const char * const deviceSupportNames[] = {
    ...
    "asynMbboDirectUInt32Digital", "devMotorAsyn", "devPrintfSoft",
...
epicsShareExtern reg_func pvar_func_MCS2MotorRegister,
    ...
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_motorRegister,
    pvar_func_motorUtilRegister, pvar_func_rsrvRegistrar,
    pvar_func_smarActMCSMotorRegister, pvar_func_smarActSCUMotorRegister,
...
int smarAct_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/epicsstudent/epics-modules/motor/modules/motorSmarAct/iocs/smarActIOC";
    ...
    runRegistrarOnce(pvar_func_MCS2MotorRegister);
    ...
    runRegistrarOnce(pvar_func_smarActMCSMotorRegister);
    runRegistrarOnce(pvar_func_smarActSCUMotorRegister);
...
/* smarAct_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: smarAct_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(smarAct_registerRecordDeviceDriver(*iocshPpdbbase));
}
